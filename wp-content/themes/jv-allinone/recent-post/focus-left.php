...
<?php if( !empty( $args['title']) ) :?>
    ...
    <?php endif; ?> </h2>
 <?php endif; ?>
	<div class="rpwe-div focus-left blog-grid row ">
		...
		<?php 
			...
			echo ($count<= 2)?"<div class='col-xs-12 col-md-6'>":"";?>
			
				<div class="innerItem  <?php  echo ($count==1)? 'top-item' : 'more-item'; ?>">
					<?php if ( $args['thumb'] ) : ?>
					...
					<div class="item-desc">
                        ...
                        <h3 class="rpwe-title">
                        	<a href="<?php echo esc_url( get_permalink() )?>" title="<?php echo sprintf( esc_attr__( 'Permalink to %s', 'jv_allinone' ), the_title_attribute( 'echo=0' ) )?>" rel="bookmark">
			 ...
			 <?php
				echo ($count== 1)?"</div>":""; //close top-item
			 ?>

		<?php endwhile; ?>
		 <?php echo "</div>"; ?> <!-- end col-right -->
