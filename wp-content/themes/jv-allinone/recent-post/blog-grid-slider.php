...
<?php if( !empty( $args['title']) ) {?>
	...
	<div class="rpwe-div slider blog-grid normal space20 cursor-move">
				...
				<div class="innerItem">
					...
					<div class="item-desc">
						<div class="item-desc-header">
							<div class="readmore-comment pull-right text-overlay">
						...
						<div class="item-excerpt">
							<?php //echo wp_trim_words( apply_filters( 'rpwe_content', get_the_content() ), $args['length'], ' [&hellip;]' )?>
