...
<div <?php echo esc_attr( ! empty( $args['cssID'] ) ? 'id="' . sanitize_html_class( $args['cssID'] ) . '"' : '' )?> class="rpwe-block <?php echo esc_attr( ! empty( $args['css_class'] ) ? '' . sanitize_html_class( $args['css_class'] ) . '' : '' )?>">
    ...
    <?php endif; ?> </h2>
 <?php endif; ?>
	<div class="rpwe-div thumb-left blog-grid">
				...
				<div class="innerItem  more-item">
					...
					<div class="item-desc">
						...
						<?php if ( $args['date'] ) : ?>
							...
							<?php endif; ?>
								<?php echo apply_filters( 'esc_html', call_user_func( 'get_the_date', 'j F Y') ); ?>
							</h5>
						<?php endif; ?>
						...
						<div class="item-meta">
							<div class="readmore-comment">
									...
									if ( $args['readmore'] ) : ?><a href="<?php echo esc_url( get_permalink() )?>" class="readmore"><?php echo apply_filters( 'rpwe_readmore', $args['readmore_text'] ) ?></a><?php endif;?>
