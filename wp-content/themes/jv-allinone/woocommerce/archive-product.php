...
<div class="group-list hidden-xs"> <span class="set-col btn  set-col1" data-style="list-1-col"><i class="icon-th-list2"></i></span> <span class="set-col btn set-coln btn-dark" data-style="list-n-col"><i class="icon-th"></i></span></div>
