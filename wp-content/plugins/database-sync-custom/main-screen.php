<div class="wrap">
	...
	<table class="form-table">
			...
			<td>
				...
				<?php foreach ($tokens as $url => $secret): ?>
					<form method="post" action="">
						...
						<p>
							<a href="<?php echo $url; ?>/wp-admin/tools.php?page=dbsc_options"><?php echo dbsc_stripHttp($url); ?></a>
							<a class="button" href="<?php echo htmlspecialchars(dbsc_url(array('dbsc_action'=>'sync', 'url'=>$url))); ?>">Sync...</a>
		...
		<tr valign="top">
			...
			<td>
				<form method="post" action="">
					<input type="hidden" name="dbsc_action" value="add">
		...
		<tr valign="top">
			...
			<td>
				<a href="<?php echo admin_url('admin-ajax.php?action=dbsc_pull&dump=manual'); ?>" target="_blank" class="button">Dump</a>
			</td>
		</tr>
	</table>
