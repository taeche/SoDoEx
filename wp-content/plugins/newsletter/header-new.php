...
<?php if (NEWSLETTER_HEADER) { ?>
    <div id="newsletter-header-new">
        ...
        <img src="<?php echo esc_attr(plugins_url('newsletter')); ?>/images/header/debug.png" style="vertical-align: middle;" title="Debug mode active!">&nbsp;&nbsp;&nbsp;
        <?php } ?>
        <img src="<?php echo esc_attr(plugins_url('newsletter')); ?>/images/header/logo.png" style="vertical-align: middle;">
...
<?php if (NEWSLETTER_DEBUG || !isset($dismissed['rate']) && $user_count > 200) { ?>
    <div class="notice">
        <a href="<?php echo esc_url($_SERVER['REQUEST_URI'] . '&dismiss=newsletter-page') ?>" class="dismiss">&times;</a>
        <p>
