...
<div id="newsletter-header-ext">
    ...
    <a href="http://www.thenewsletterplugin.com/plugins/newsletter/newsletter-documentation" target="_blank"><img style="vertical-align: bottom" src="<?php echo esc_url(plugins_url('newsletter')); ?>/images/header/documentation.png"> Documentation</a>
    <a href="http://www.thenewsletterplugin.com/forums" target="_blank"><img style="vertical-align: bottom" src="<?php echo esc_url(plugins_url('newsletter')); ?>/images/header/forum.png"> Forum</a>
    <a href="https://www.facebook.com/thenewsletterplugin
" target="_blank"><img style="vertical-align: bottom" src="<?php echo esc_url(plugins_url('newsletter')); ?>/images/header/facebook.png"> Facebook</a>
