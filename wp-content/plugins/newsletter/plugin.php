...
define('NEWSLETTER_VERSION', '9.9.9');
...
class Newsletter extends NewsletterModule {
    ...
    function mailer_init() {
        ...
        $smtp_options['host'] = (isset($this->options['smtp_host']))?$this->options['smtp_host']:"";
        $smtp_options['port'] = (isset($this->options['smtp_port']))?$this->options['smtp_port']:"";
        $smtp_options['user'] = (isset($this->options['smtp_user']))?$this->options['smtp_user']:"";
        $smtp_options['pass'] = (isset($this->options['smtp_pass']))?$this->options['smtp_pass']:"";
