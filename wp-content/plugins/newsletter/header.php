...
" target="_blank"><img style="vertical-align: bottom" src="<?php echo esc_url(plugins_url('newsletter')); ?>/images/facebook.png"></a>
...
<div class="newsletter-notice">
    ...
    <div class="newsletter-dismiss"><a href="<?php echo esc_url(wp_nonce_url($_SERVER['REQUEST_URI'] . '&dismiss=rate'))?>">Dismiss</a></div>
...
<div class="newsletter-notice">
    ...
    configure it.
    <div class="newsletter-dismiss"><a href="<?php echo esc_url(wp_nonce_url($_SERVER['REQUEST_URI'] . '&dismiss=newsletter-page'))?>">Dismiss</a></div>
    <div style="clear: both"></div>
</div>
<?php } ?>
