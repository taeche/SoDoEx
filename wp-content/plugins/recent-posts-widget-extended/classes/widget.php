...
class Recent_Posts_Widget_Extended extends WP_Widget {
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['cat']              = isset( $new_instance['cat'] ) ? $new_instance['cat'] : false;
		$instance['tag']              = isset( $new_instance['tag'] ) ? $new_instance['tag'] : false;
		...
		$instance['tmpl']             = isset( $new_instance['tmpl'] ) ? $new_instance['tmpl'] : '';
		$instance['col']              = isset( $new_instance['col'] ) ? $new_instance['col'] : '1';
        $instance['dtitle']           = isset( $new_instance['dtitle'] ) ? $new_instance['dtitle'] : '0';
		$instance['dcomment']         = isset( $new_instance['dcomment'] ) ? $new_instance['dcomment'] : '0';
		$instance['dauthor']          = isset( $new_instance['dauthor'] ) ? $new_instance['dauthor'] : '0';
		$instance['dcategory']        = isset( $new_instance['dcategory'] ) ? $new_instance['dcategory'] : '0';
