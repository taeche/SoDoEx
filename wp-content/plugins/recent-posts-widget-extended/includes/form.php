...
<p class="column width30">
			<label for="<?php echo $this->get_field_id( 'tmpl' ); ?>">
				<?php _e( 'Template', 'rpwe' ); ?>
			</label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'tmpl' ); ?>" name="<?php echo $this->get_field_name( 'tmpl' ); ?>" type="text" value="<?php echo sanitize_html_class( $instance['tmpl'] ); ?>"/>
</p>
...
<?php $tid = rand( 0, 10000 ) ?>

<div class="wrap-tab">
	<ul class="rpwe-tab">
		<li class="active"><a data-action="tab" data-hide=".tab-pane" href="#rpwe-default-<?php echo $tid?>"><?php _e( 'Default', 'rpwe' ); ?></a></li>
		<li><a data-action="tab" data-hide=".tab-pane"  href="#rpwe-advance-<?php echo $tid?>"><?php _e( 'Advance', 'rpwe' ); ?></a></li>
	</ul>

	<div id="rpwe-default-<?php echo $tid?>" class="rpwe-columns-2 tab-pane fade">



<div class="cols2">
<div class="rpwe-multiple-check-form column">
			<label>
...
<div class="column">
		...
		<p>
			<label class="rpwe-block" for="<?php echo $this->get_field_id( 'col' ); ?>">
				<?php _e( 'Number of column', 'rpwe' ); ?>
			</label>
			<select  id="<?php echo $this->get_field_id( 'col' ); ?>" name="<?php echo $this->get_field_name( 'col' ); ?>">
				<option value="1" <?php selected( $instance['col'], '1' ); ?>><?php _e( 'One', 'rpwe' ) ?></option>
				<option value="2" <?php selected( $instance['col'], '2' ); ?>><?php _e( 'Two', 'rpwe' ) ?></option>
				<option value="3" <?php selected( $instance['col'], '3' ); ?>><?php _e( 'Three', 'rpwe' ) ?></option>
				<option value="4" <?php selected( $instance['col'], '4' ); ?>><?php _e( 'Four', 'rpwe' ) ?></option>
				<option value="6" <?php selected( $instance['col'], '6' ); ?>><?php _e( 'Six', 'rpwe' ) ?></option>
			</select>
		</p>   

		<p>
			<label for="<?php echo $this->get_field_id( 'offset' ); ?>">
				<?php _e( 'Offset', 'rpwe' ); ?> <small><?php _e( 'The number of posts to skip', 'rpwe' ); ?></small>
			</label>
...
<div class="cols2">
    ...
    <div class="column">
        ...
        <p>
            <input id="<?php echo $this->get_field_id( 'dtitle' ); ?>" name="<?php echo $this->get_field_name( 'dtitle' ); ?>" type="checkbox" <?php checked( $instance['dtitle'] ); ?> value="1" />
            <label class="input-checkbox" for="<?php echo $this->get_field_id( 'dtitle' ); ?>">
                <?php _e( 'Display Title', 'rpwe' ); ?>
            </label>
        </p>
		...
		<p>
			<input id="<?php echo $this->get_field_id( 'dcomment' ); ?>" name="<?php echo $this->get_field_name( 'dcomment' ); ?>" type="checkbox" <?php checked( $instance['dcomment'] ); ?> value="1" />
			<label class="input-checkbox" for="<?php echo $this->get_field_id( 'dcomment' ); ?>">
				<?php _e( 'Display Comment', 'rpwe' ); ?>
			</label>
		</p>
		<p>
			<input id="<?php echo $this->get_field_id( 'dauthor' ); ?>" name="<?php echo $this->get_field_name( 'dauthor' ); ?>" type="checkbox" <?php checked( $instance['dauthor'] ); ?> value="1" />
			<label class="input-checkbox" for="<?php echo $this->get_field_id( 'dauthor' ); ?>">
				<?php _e( 'Display author', 'rpwe' ); ?>
			</label>
		</p>
		<p>
			<input id="<?php echo $this->get_field_id( 'dcategory' ); ?>" name="<?php echo $this->get_field_name( 'dcategory' ); ?>" type="checkbox" <?php checked( $instance['dcategory'] ); ?> value="1" />
			<label class="input-checkbox" for="<?php echo $this->get_field_id( 'dcategory' ); ?>">
				<?php _e( 'Display category', 'rpwe' ); ?>
			</label>
		</p>
...
<div class="cols2">
    ...
    <div class="rpwe-multiple-check-form">
		...
		<div style="display: none" class="rpwe-multiple-check-form">
			<label>
	...
	<div id="rpwe-advance-<?php echo $tid?>" class="rpwe-columns-2 tab-pane fade hide">
...
<p >
	...
	<script>
		jQuery( function( $ ) {
			$('.rpwe-tab').delegate( '[data-action="tab"]', 'click', function(){
				
				var $this = $( this );
				
				$this.closest( '.wrap-tab' ).find( $this.data( 'hide' ) ).each( function(){ $( this ).addClass( 'hide' ); } );
