...
<tr class="last">
    ...
    <td>  
        ...
        if (get_option('autoptimize_show_adv','0')=='1') {
            ?>
            <a href="javascript:void(0);" id="ao_show_adv" class="button button-hero" style="display:none;"><?php _e("Show advanced settings","autoptimize") ?></a>
            <a href="javascript:void(0);" id="ao_hide_adv" class="button button-hero"><?php _e("Hide advanced settings","autoptimize") ?></a>
            <style>.ao_adv {display:table-row};</style>
            <?php
        } else {
            ?>
            <a href="javascript:void(0);" id="ao_show_adv" class="button button-hero"><?php _e("Show advanced settings","autoptimize") ?></a>
            <a href="javascript:void(0);" id="ao_hide_adv" class="button button-hero" style="display:none;"><?php _e("Hide advanced settings","autoptimize") ?></a>
            <?php
        }
        ?>
        <input type="submit" data-action="optimize" class="button button-hero button-primary" value="<?php _e('Save Optimize Changes','autoptimize') ?>" />
        <input type="submit" data-action="optimize" class="button button-hero button-primary right" name="autoptimize_cache_clean" value="<?php _e('Save Optimize Changes and Empty Cache','autoptimize') ?>" />
        </p>     
    </td>
</tr>
</table>
...
<?php
	...
	{
		add_action( 'jvtheme_optimize', array( $this,'show' ) );
	}
